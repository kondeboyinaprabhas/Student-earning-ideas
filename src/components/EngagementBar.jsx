    ...
    <>
      <div className="grid grid-cols-4 gap-2 py-3 border-y border-slate-100 dark:border-slate-800 my-3 select-none">
        ...
        >
          ...
          <span className="text-[9px] uppercase tracking-wider text-slate-400 font-medium">Like</span>
        </button>
        ...
        >
          ...
          <span className="text-[9px] uppercase tracking-wider text-slate-400 font-medium">Send</span>
        </button>
        ...
        >
          ...
          <span className="text-[9px] uppercase tracking-wider text-slate-400 font-medium">Bookmark</span>
        </button>
        ...
        >
          ...
          <span className="text-[9px] uppercase tracking-wider text-slate-400 font-medium">Audio</span>
        </button>
      </div>
